...
require (
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-aws-common v0.0.4
	...
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-kafka-common v0.2.82
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-mongo-common v0.0.36
